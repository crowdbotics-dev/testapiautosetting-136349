"""
Django settings for testapiautosetting_136349 project.
...
ROOT_URLCONF = 'testapiautosetting_136349.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136349.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettingsj5ik8 Support <support@testapiautosetting-136349.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136349 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136349 App",
    "VERSION": "v1",
}
